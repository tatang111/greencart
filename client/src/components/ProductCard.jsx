...
export const ProductCard = ({ product }) => {
  const { currency, addToCart, cartItems, removeCartItem } = useStore();
  ...
  return (
    product && (
      <div
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white w-47 md:w-56 max-w-full "
      >
